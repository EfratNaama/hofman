...
Final Project – Full Stack Software Engineering | Azrieli College, Jerusalem
...
Beit Hoffman is a community center for the third age operating in Jerusalem, offering a wide variety of activities and programs for the senior citizens population. Among the included activities: art classes, lectures, cultural events, sports and physical activity, social clubs and community events.

Today, the center relies on traditional communication channels such as telephone, flyers and physical notice boards for distributing information. The absence of a central digital presence makes it difficult to make information accessible to the general public and to efficiently manage the many activities.

---

# 3. Problem Statement

The center does not maintain an organized digital presence, and potential users have no convenient access to up-to-date information about activities, event schedules, opening hours and registration options. As a result:

- Senior citizens have difficulty locating up-to-date information about the center's programs
- Registration for activities requires manual and burdensome telephone contact
- Updates and announcements arrive late or do not arrive at all
- The center's management invests considerable time and resources in managing information through inefficient channels
...
- Senior citizens and third-age individuals residing in Jerusalem and its surroundings
- Family members and caregivers looking for activities for their loved ones
- People interested in learning about and getting an impression of the center's services for the purpose of making a donation independently
...
## 6.1 User Side – Visitor Interface
...
- Contact form with center staff
- Accessible interface – large font, high color contrast, simple and familiar layout
...
- Uploading and removing images and documents
- Secured access with a dedicated login mechanism for administrators
...
- Development of an independent payment system – access to the existing external payment system will be done through links only; the website does not process payments, store credit card details, or perform payment clearing
...
The following features are not included in the current version but are proposed for future development:

- Development of a dedicated mobile application (iOS and Android)
- Sending automatic reminders to registrants for activities (SMS / email)
- Adding an internal community forum for center participants
- Statistics and reports system for center management
- Integration with an external calendar (Google Calendar)
- Expansion of interface languages to Arabic and English

---

*This document was prepared as part of a Full Stack Software Engineering final project | 2025–2026*
